...
class CheckIfBondCheckPerfomed extends Command
{
    ...
    public function handle()
    {
        ...
        if (!$airlines->isEmpty()) {
            Mail::to(env('MAIL_TEAM_ADDRESS'))->bcc(['dwanyoike@afske.aero'])->cc(['mnjoroge@afske.aero', 'mwalker@afske.aero', 'cgwaro@afske.aero'])->send(new BondCheckReminder($airlines));
        }
        return 0;
    }
}
